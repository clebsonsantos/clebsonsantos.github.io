(function ($) {
  ...
  $('.back-to-top').click(function(){
	...
	// quando o button for pressionado aparecerá o modal
	// se a mensagem for enviada para o formspree a mensagemn de sucesso será mostrada
	// caso contrario a messagem de erro será mostrada
